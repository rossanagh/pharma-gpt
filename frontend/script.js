...
const T = {
  ...
  ro:{
    ...
    "Enter demographics and clinical details for this visit, then tap Save or OK.":"Completează demografia și detaliile clinice pentru această consultație, apoi apasă Salvează sau OK.",
